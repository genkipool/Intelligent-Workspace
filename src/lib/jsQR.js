...
!(function (o, e) {
    ...
    return (function (o) {
        ...
        return (
            ...
            (r.c = e),
            (r.d = function (o, e, t) {
                r.o(o, e) || Object.defineProperty(o, e, { configurable: !1, enumerable: !0, get: t });
            }),
            (r.n = function (o) {
                var e =
                    o && o.__esModule
            ...
            var t = (function () {
                ...
                return (
                    ...
                    (o.prototype.get = function (o, e) {
                        return (
                            !(o < 0 || o >= this.width || e < 0 || e >= this.height) && !!this.data[e * this.width + o]
                        );
                    }),
            ...
            var c = (function () {
                function o(o, e, r) {
                    ...
                    for (var c = 1, s = 0; s < this.size; s++)
                        ((this.expTable[s] = c), (c *= 2) >= this.size && (c = (c ^ this.primitive) & (this.size - 1)));
                ...
                return (
                    (o.prototype.multiply = function (o, e) {
                        return 0 === o || 0 === e
                            ? 0
                            : this.expTable[(this.logTable[o] + this.logTable[e]) % (this.size - 1)];
                    }),
                    ...
                    return (
                        ...
                        (o.prototype.addOrSubtract = function (e) {
                            ...
                            for (var a = new Uint8ClampedArray(s.length), n = s.length - c.length, d = 0; d < n; d++)
                                a[d] = s[d];
                            for (d = n; d < s.length; d++) a[d] = t.addOrSubtractGF(c[d - n], s[d]);
        ...
        function (o, e, r) {
            ...
            e.binarize = function (o, e, r, a) {
                ...
                for (a && (x = t.BitMatrix.createEmpty(e, r)), f = 0; f < C; f++)
                    for (w = 0; w < u; w++) {
                        for (var M = c(w, 2, u - 3), L = c(f, 2, C - 3), N = ((P = 0), -2); N <= 2; N++)
        ...
        function (o, e, r) {
                    ...
                    var c = i[r.dataMask],
                        ...
                        a = (function (o) {
                            ...
                            return (
                                ...
                                o.versionNumber > 6 &&
                                    (r.setRegion(e - 11, 0, 3, 6, !0), r.setRegion(0, e - 11, 6, 3, !0)),
                                r
                            );
                        })(e),
                        n = [],
            ...
            function k(o) {
                var e = (function (o) {
                    ...
                    for (var t = 0, c = 5; c >= 0; c--) for (var s = e - 9; s >= e - 11; s--) t = d(o.get(s, c), t);
                    var l = 0;
                    for (s = 5; s >= 0; s--) for (c = e - 9; c >= e - 11; c--) l = d(o.get(s, c), l);
                    for (var i, B = 1 / 0, k = 0, u = a.VERSIONS; k < u.length; k++) {
                        var C = u[k];
                        if (C.infoBits === t || C.infoBits === l) return C;
                        var m = n(t, C.infoBits);
                        (m < B && ((i = C), (B = m)), (m = n(l, C.infoBits)) < B && ((i = C), (B = m)));
                    }
                    return B <= 3 ? i : void 0;
                })(o);
                if (!e) return null;
                var r = (function (o) {
                    for (var e = 0, r = 0; r <= 8; r++) 6 !== r && (e = d(o.get(r, 8), e));
                    ...
                    for (var a = 1 / 0, i = null, B = 0, k = l; B < k.length; B++) {
                        ...
                        if (C === e || C === s) return m;
                        var f = n(e, C);
                        (f < a && ((i = m), (a = f)), e !== s && (f = n(s, C)) < a && ((i = m), (a = f)));
                    }
                    return a <= 3 ? i : null;
                })(o);
                if (!r) return null;
                var t = (function (o, e, r) {
                    ...
                    if (
                        (t.ecBlocks.forEach(function (o) {
                            for (var e = 0; e < o.numBlocks; e++)
                                (c.push({ numDataCodewords: o.dataCodewordsPerBlock, codewords: [] }),
                    ...
                    for (var a = t.ecBlocks[0].dataCodewordsPerBlock, n = 0; n < a; n++)
                        for (var d = 0, l = c; d < l.length; d++) l[d].codewords.push(o.shift());
            ...
            e.decode = function (o) {
                ...
                for (var r = 0; r < o.width; r++)
                    for (var t = r + 1; t < o.height; t++)
                        o.get(r, t) !== o.get(t, r) && (o.set(r, t, !o.get(r, t)), o.set(t, r, !o.get(t, r)));
                return k(o);
            };
        },
        function (o, e, r) {
            ...
            function n(o, e) {
                for (var r = [], t = '', c = [10, 12, 14][e], s = o.readBits(c); s >= 3; ) {
                    ...
                    var a = Math.floor(l / 100),
                        ...
                        d = l % 10;
                    (r.push(48 + a, 48 + n, 48 + d), (t += a.toString() + n.toString() + d.toString()), (s -= 3));
                }
                if (2 === s) {
            ...
            function l(o, e) {
                for (var r = [], t = '', c = [9, 11, 13][e], s = o.readBits(c); s >= 2; ) {
                    var a = o.readBits(11),
                        n = Math.floor(a / 45),
                        l = a % 45;
                    (r.push(d[n].charCodeAt(0), d[l].charCodeAt(0)), (t += d[n] + d[l]), (s -= 2));
                }
                if (1 === s) {
                    n = o.readBits(6);
            ...
            var t = (function () {
                ...
                return (
                    (o.prototype.readBits = function (o) {
                        ...
                        if (o > 0) {
                            for (; o >= 8; )
                                ((e = (e << 8) | (255 & this.bytes[this.byteOffset])), this.byteOffset++, (o -= 8));
                            if (o > 0) {
                                var s;
                                c = (255 >> (s = 8 - o)) << s;
                ...
                var B = new c.default(s, n),
                    k = (function (o, e, r, t) {
                        ...
                        for (var s = e, a = r, n = o.zero, d = o.one; a.degree() >= t / 2; ) {
                            ...
                            a = l;
                            for (
                                var B = o.zero, k = s.getCoefficient(s.degree()), u = o.inverse(k);
                            ...
                            if (((d = B.multiplyPoly(n).addOrSubtract(i)), a.degree() >= s.degree())) return null;
                        }
                ...
                for (
                    var r,
                        ...
                        i = function (o, e) {
                            ...
                            return { x: (d.a11 * o + d.a21 * e + d.a31) / r, y: (d.a12 * o + d.a22 * e + d.a32) / r };
                        },
                        B = 0;
                    B < e.dimension;
                    B++
        ...
        function (o, e, r) {
            ...
            function s(o, e, r, c) {
                ...
                i
                    ? ((s = Math.floor(o.y)), (a = Math.floor(o.x)), (n = Math.floor(e.y)), (d = Math.floor(e.x)))
                    : ((s = Math.floor(o.x)), (a = Math.floor(o.y)), (n = Math.floor(e.x)), (d = Math.floor(e.y)));
                for (
                    var B = Math.abs(n - s),
                        k = Math.abs(d - a),
                        u = Math.floor(-B / 2),
                    ...
                    var v = i ? P : w,
                        h = i ? w : P;
                    if (r.get(v, h) !== f && ((f = !f), l.push({ x: v, y: h }), l.length === c + 1)) break;
                    if ((u += k) > 0) {
                        if (P === d) break;
                        ((P += m), (u -= B));
                    }
            ...
            function d(o, e, r) {
                try {
                    var t = a(o, { x: -1, y: o.y }, r, e.length),
                        ...
                        s = a(o, { x: Math.max(0, o.x - o.y) - 1, y: Math.max(0, o.y - o.x) - 1 }, r, e.length),
                        d = a(
                            o,
                            { x: Math.min(r.width, o.x + o.y) + 1, y: Math.min(r.height, o.y + o.x) + 1 },
                            r,
                            e.length,
                        ),
                        l = n(t, e),
            ...
            function i(o, e, r, s, n) {
                        ...
                        .map(function (e) {
                            ...
                            if (o.get(Math.floor(r), Math.floor(s))) {
                                ...
                                return {
                                    ...
                                    y: s,
                                    score:
                                        d({ x: Math.floor(r), y: Math.floor(s) }, [1, 1, 1], o) + t({ x: r, y: s }, f),
                                };
                            }
                        })
                        .filter(function (o) {
                ...
                return { alignmentPattern: C >= 15 && w.length ? w[0] : f, dimension: i };
            }
            e.locate = function (o) {
                for (
                    var e = [],
                    ...
                    .map(function (e) {
                        ...
                        if (o.get(Math.round(r), Math.round(t))) {
                            var s = [
                                ...
                                a = c(s) / s.length;
                            return {
                                score: d({ x: Math.round(r), y: Math.round(t) }, [1, 1, 3, 1, 1], o),
                                x: r,
                                y: t,
                                size: a,
                            };
